...
function Blobs() {
    return (
        <div>
            <svg className="bottom-left-blob" width="148" height="118" viewBox="0 0 148 118" fill="none"
            ...
            <svg className="top-right-blob" width="194" height="197" viewBox="0 0 194 197" fill="none" xmlns="http://www.w3.org/2000/svg">
